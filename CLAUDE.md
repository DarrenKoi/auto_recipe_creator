...
uv run pytest poc/workflow_3/monitor/test_demonstration_rcs_control.py  # 113 (시연 흐름 + 확인 게이트 + 클릭/대문자 입력 + Alt+click 가림 해제)
