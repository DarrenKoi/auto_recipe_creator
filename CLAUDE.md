...
uv run pytest poc/workflow_3/monitor/test_demonstration_rcs_control.py  # 88 (시연 흐름 + 확인 게이트 + 클릭 순서 + 메모 타이핑 + Alt+click 가림 해제)
