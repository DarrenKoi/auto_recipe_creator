...
uv run python poc/workflow_3/monitor/make_demo_video_combined.py   # 최근 recipe 의 회차 전부
DEMO_COMBINED_ROOT=<captured_img_from_rcs 경로> DEMO_COMBINED_LABELS="Baseline,After tuning" \
