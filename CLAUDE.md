...
DEMO_RCS_TOOL_IDS="MCD019,MCDC22" DEMO_RCS_DWELL_SEC=10 \
  uv run python poc/workflow_3/monitor/demonstration_rcs_control.py
...
uv run pytest poc/workflow_3/monitor/test_demonstration_rcs_control.py  # 112 (시연 흐름 + 확인 게이트 + 클릭/대문자 입력 + Alt+click 가림 해제)
