...
```text
Ingest 대상: docs/llm-wiki/raw/journals
...
2. 영향받는 wiki/ 페이지 식별 — 기존 갱신 + 신규 생성.
   - 새 페이지는 docs/llm-wiki/_templates/ 의 해당 템플릿을 베이스로.
...
5. docs/llm-wiki//wiki/index.md 의 해당 섹션에 새 페이지 등록.
