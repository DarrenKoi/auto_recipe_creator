...
**대응 시간과 환산.** 3건은 표본이 작아 운영 성공률로 일반화하지 않고 배치 후 건별로 계속 기록합니다. 환산은 건당 4분 × 주 400건, 웨이퍼 1장 측정 15분, 장비 1대 약 20억 원 기준이며 배치 후 실측으로 바꿉니다.
...
| 재등록 필요성 판단 | 경험에 의존 | 헷갈리는 Align Key Recipe 목록 자동 산출 |
