...
- **현업 엔지니어가 시험 환경과 판단 규칙을 만들어 줬습니다.** 시험용 웨이퍼와 Recipe로 Align Fail 재현 환경을 구축해 실알람을 기다리지 않고 기능을 확인했고, 저배율·고배율에서 Align Key가 다르게 보인다는 장비 지식이 촬영 모드별 판정 방식과 완료 판정 기준이 됐습니다.
...
| **이상치 필터·예외 알림** | 확인 안 되면 클릭·보정 보류, 원인·요구 행동을 담아 담당자에게 큐브 알림 | 불확실한 조작은 하지 않고 담당자는 예외만 판단 |
