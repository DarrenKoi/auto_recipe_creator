...
- **현업 엔지니어가 시험 환경과 판단 규칙을 만들어 줬습니다.** 시험용 웨이퍼와 Recipe로 Align Fail 재현 환경을 구축해 실알람을 기다리지 않고 기능을 확인했고, 저배율·고배율에서 Align Key가 다르게 보인다는 장비 지식은 촬영 모드별 판정 방식에, 실패 중에도 측정 카운터가 올라간다는 현장 확인은 완료 판정 기준에 반영됐습니다.
