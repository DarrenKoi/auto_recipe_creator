...
| 02 | [02_workflow_1.md](02_workflow_1.md) | **첫번째 워크플로우 구현** — RCS GUI 자동화 + CCTV 캡처 PoC. 핵심 확보 기술(클릭·타이핑 90%+·재시도/fallback·rescale), 데이터 자산화, CCTV 한계·개선 |
| 03 | [03_workflow_2.md](03_workflow_2.md) | **정렬 재조정 CV 평가** — Recipe 200개 오프라인 평가. 등록 1장 vs 성공 사례 종합(consensus), in_topk·rank1·OM/SEM 결과, 아이디어별 실험과 결정/남은 평가 |
| 04 | [04_workflow_3.md](04_workflow_3.md) | **실시간 Align Fail 자동 대응 Agent** — 10초 알람 감지(9006)→RCS 접속→자동 보정, consensus gather 병렬, 오측 감지 시 측정 중단·Cube 알람, 지식 자산화, **진행 현황·향후 일정**(현재 주력) |
