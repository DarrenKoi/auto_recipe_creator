...
def build_rcs_select_tool_prompt(
    ...
    lines = [
        ...
        "- Return one coordinate for DOUBLE-CLICK on the LAST visible letter of the matched tool name.",
        "- The click point must be on the text glyph of that last letter (not whitespace).",
        "- Do not click the status-light itself.",
        "- Do not estimate from row center or bounding-box center.",
