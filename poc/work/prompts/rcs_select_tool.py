...
def build_rcs_select_tool_prompt(
    ...
    lines = [
        ...
        "- For text-based coordinate detection, ALWAYS anchor on the first visible letter of the target text.",
        "- Return one coordinate for DOUBLE-CLICK on the FIRST LETTER of the matched tool name.",
        "- Never use the middle/end of the tool name text.",
        "- Never estimate a coordinate from row center or bounding-box center.",
